...
####Joining datasets------
#not wind speed not joined as there isn't enough data
...
mtry <- c(1:32) # The maximum number of independent variables are 32
...
# Sensitivity = .385
# AUC = .690
# This means the model will predict a critical fault code 38.5% of the time correctly when there is actually a critical issue and
# that the model will predict non critical occurrences 97.5% of the time correctly when there is actually no critical issues.
