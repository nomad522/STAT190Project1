...
# Renaming columns
names(fully_joined) <- c("Turbine", "FaultCode","Description", "Timestamp", "Bearing_Temp", "Windspeed", "Hydraulic_Pressure", "Generator_RPM", "Oil_Temp", "Gearbox_IMS", "Active_Power", "Ambient_Temp")
...
for (i in 1:nrow(fully_joined)){
  if (is.na(fully_joined$Description[i])){fully_joined$FaultCodeType[i] = "Other"}
  else if (fully_joined$Description[i] == "Gear Oil Temperature High"||
      fully_joined$Description[i] == "Gear Oil Pressure Too High/Low"||
      fully_joined$Description[i] == "Converter Tripped, Auto Start" ||
      fully_joined$Description[i] == "Mainbreaker Cut Out"||
      fully_joined$Description[i] == "Gear Oil Pump/Blower Superheated"||
      fully_joined$Description[i] == "Ups Bypass Error"||
      fully_joined$Description[i] == "Ups-Failure"||  
      fully_joined$Description[i] == "Slip Ring Error"||
      fully_joined$Description[i] == "Osc. In Gen Speed, Cons. Lim"||
      fully_joined$Description[i] == "Ims-Gen Gearbearing Temp Too High"||
      fully_joined$Description[i] == "Ups-Failure"||
      fully_joined$Description[i] == "Hs-Gen Gearbearing Superheated"||
      fully_joined$Description[i] == "Grid Filter Current Overload"||
      fully_joined$Description[i] == "Gearoil Level Too Low"||
      fully_joined$Description[i] == "Rpm Sensor Error"||
      fully_joined$Description[i] == "Srsg Activated"||
      fully_joined$Description[i] == "Lms-Rot Gearbearing Temp Too High"
      ){fully_joined$FaultCodeType[i] = "Critical"}
  else if (fully_joined$Description[i] == "Gear Oil Temperature Warning"||
           fully_joined$Description[i] == "Converter Trip, External"||
           fully_joined$Description[i] == "Converter Tripped, General"||
           fully_joined$Description[i] == "Main Bearing Temp Too High"||
           fully_joined$Description[i] == "Generator High Speed Waiting"||
           fully_joined$Description[i] == "Inv.(Tow) Cool Water Pres. Warning"||
           fully_joined$Description[i] == "Inv.(Tow) Cool Water Pres. Low"||
           fully_joined$Description[i] == "Tower Conv. Cooling Water Low"||
           fully_joined$Description[i] == "Hydraulic Filter Warning"||
           fully_joined$Description[i] == "Gear Oil Temp Sensor Warning"||
           fully_joined$Description[i] == "Main Bearing Temp Warning"||
           fully_joined$Description[i] == "Lmu Alarm Overspeed"||
           fully_joined$Description[i] == "Brake Pressure Too Low"||
           fully_joined$Description[i] == "Inverter Temperature High"||
           fully_joined$Description[i] == "Grdinv: 38 D1 Volt High"||
           fully_joined$Description[i] == "Grease Level Low, Gen Bearings"||
           fully_joined$Description[i] == "Grdinv: 38 D1 Volt High"||
           fully_joined$Description[i] == "Yaw Limit Sensor Activated"||
           fully_joined$Description[i] == "No Lubrication, Gen Bearings"||
           fully_joined$Description[i] == "Brake (Gen) Temperature Error"||
           fully_joined$Description[i] == "Dc Voltage Low"||
           fully_joined$Description[i] == "Grease Level Low, Hub"||
           fully_joined$Description[i] == "Geninv: 38 D1 Volt High"||
           fully_joined$Description[i] == "Gearoil Level Too Low"||
           fully_joined$Description[i] == "Geninv: 56 D3 Volt High"||
           fully_joined$Description[i] == "Inv. Cooling Water Temp Warning"||
           fully_joined$Description[i] == "Delta Module Temperature High"||
           fully_joined$Description[i] == "Gear Oil Temp Sensor Warning"||
           fully_joined$Description[i] == "Gear Bearing Hs-Gen Sensor Warning"||
           fully_joined$Description[i] == "Gear Bearing Hs-Rot Sensor Warning"||
           fully_joined$Description[i] == "Gear Bearing Ims-Gen Sensor Warning"||
           fully_joined$Description[i] == "Gear Bearing Ims-Rot Sensor Warning"||
           fully_joined$Description[i] == "Hs-Rot Gearbearing Temp Warning"||
           fully_joined$Description[i] == "Fuse Blown, Grid Filter"||
           fully_joined$Description[i] == "Hs-Gen Gearbearing Temp Warning"||
           fully_joined$Description[i] == "High Upper Voltage Exceeded"||
           fully_joined$Description[i] == "Low Lower Voltage Exceeded"||
           fully_joined$Description[i] == "UPS Battery Low, Warning"||
           fully_joined$Description[i] == "Ups Battery Low"||
           fully_joined$Description[i] == "Dc Fuse Blown"||
           fully_joined$Description[i] == "Gear Oil Temperature Low"||
           fully_joined$Description[i] == "Hydraulic Oil Too Cold"||
           fully_joined$Description[i] == "Blown Yaw Brake Fuse"||
           fully_joined$Description[i] == "Too Many Slip Ring Errors"||
           fully_joined$Description[i] == "No Lubrication, Yaw System"||
           fully_joined$Description[i] == "Lmu Sensor Error"||
           fully_joined$Description[i] == "Srsg Activated"
  ){fully_joined$FaultCodeType[i] = "Warning"}
...
db$Date <- ymd(db$Date)
db$wo_finish_date <- ymd(db$wo_finish_date)
