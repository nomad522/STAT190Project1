...
# load save point
fully_joined <- read.csv("Data/Wind Turbine Data Batch 2/final_data-v5.csv")
...
test2 = subset(fully_joined, Turbine == "Turbine 13")

# Will need to try for only data set 2. This was originally for the combination of data set 1 & 2
...
# this executes, but I do not like the negative temps for certain sensors and imputed values are now too high and too low
...
#Read in raw dataset
db <- read.csv("Data/Wind Turbine Data Batch 2/final_data-v5.csv", stringsAsFactors = TRUE)
...
data = pd.read_csv("Data/Wind Turbine Data Batch 2/final_data-v5.csv")
