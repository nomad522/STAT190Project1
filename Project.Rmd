...
fully_joined <- read.csv("final_data-v3.csv")
View(fully_joined)

#Convert date time from char to date time 
fully_joined$DateTime <- ymd_hms(fully_joined$DateTime)
fully_joined$round_date <- ymd_hms(fully_joined$round_date)
str(fully_joined)

#Delete all duplicate rows
fully_joined <- fully_joined[!duplicated(fully_joined[,8:9]),]
View(fully_joined)

#Order based on Turbine and date
fully_joined <- fully_joined %>% arrange(location_id, round_date)
View(fully_joined)
