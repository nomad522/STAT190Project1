...
This project can be ran top to bottom. 
...
# Target Variable
Creation of variables for prediction and graphing
FaultCodeType
BinaryFaul
...
## Lag varaibles
Lag variables, by 6 hours, are created for predictive modeling.
...
# Creating lag variables by 6 hours, using the dyplr lag function.
...
## Matrix
A variable maxtrix was created in hopes finding correlations.
...
#Notes:
# orginally made only for the unlagged and unimputed data sets.
...
# This was orginally created for data set prior to batch 2 and probably wont run now.
# This is python code.
...
####### Doesn't run graph-------
# Goal was to graph IMS temperature (and other variables) in a time sereies with fault code events, but geom_vline wasn't working.
