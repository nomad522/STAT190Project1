...
# Renaming columns
names(fully_joined) <- c("Turbine", "Timestamp",  "Windspeed", "Bearing_Temp", "Hydraulic_Pressure","Generator_RPM","Oil_Temp","Gearbox_IMS_1", "Gearbox_IMS_2", "Active_Power", "Ambient_Temp", "FaultCode", "Description","Type","Date")
...
column_list = colnames(ts_imputed)[c(3:11)]
