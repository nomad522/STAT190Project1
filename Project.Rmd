...
myforest <- randomForest(BinaryFault ~ Turbine + lagHSB + lagPressure + lagRPM + lagOil + lagIMS1 + lagIMS2 + lagPower, # dangers here
             data = train.df,
             ntree = 500, # b
             mtry = 2,
             importance = TRUE)
...
mtry <- c(1:6) #only have 12 variables - thus can only vary between 1 to 12
